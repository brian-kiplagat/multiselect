...
const disabledOptionsExample = document.getElementById(
  "disabled-options-example"
);
...
if (interactiveExample) {
  ...
  const multiSelect = new MultiSelect({
    ...
    onCreateOption: (value, instance) => {
      console.log(`Creating option with value: ${value}`);
  ...
  if (btnToggleDisabled) {
    btnToggleDisabled.addEventListener("click", () => {
      if (multiSelect.getSelected()) {
        ...
        if (
          (btnToggleDisabled as HTMLButtonElement).textContent ===
          "Toggle Disabled"
        ) {
          multiSelect.disable();
  ...
  if (btnToggleReadonly) {
    btnToggleReadonly.addEventListener("click", () => {
      if (multiSelect.getSelected()) {
        if (
          (btnToggleReadonly as HTMLButtonElement).textContent ===
          "Toggle ReadOnly"
        ) {
...
const hideAfterSelectExample = document.getElementById(
  "hide-after-select-example"
);
